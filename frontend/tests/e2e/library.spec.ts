  ...
  podcasts: [
    {
      podcastId: 'podcast-1',
      title:
        'This Is An Extremely Long Podcast Title That Should Cause Layout Issues When Displayed In The Library Component Because It Exceeds Normal Length Expectations',
      description:
        'This is an extremely long podcast description that goes on and on and on and should cause text wrapping issues in the library component layout. The description contains multiple sentences that describe the podcast in great detail, including information about the hosts, the format, the topics covered, and the target audience. This lengthy description is designed to test how the UI handles very long text content and whether it truncates properly or causes layout breaking issues.',
...
const mockEpisodesResponse = {
  episodes: [
    ...
    },
    {
      ...
      podcastId: 'podcast-1',
      title:
        'Episode 2: Another Episode With An Exceptionally Long Title That Tests The Boundaries Of The Episode Card Layout System And Text Wrapping Capabilities',
      description:
        'Another extremely verbose episode description with multiple sections of detailed information. This episode features in-depth discussions about various topics, expert analysis, and practical insights. The content is designed to provide comprehensive coverage of the subject matter while also testing the UI layout system with extensive text content.',
    ...
    },
    {
      ...
      podcastId: 'podcast-1',
      title:
        'Episode 3: Yet Another Episode With A Ridiculously Long Title That Should Push The Episode Card Component To Its Absolute Limits And Beyond',
      description:
        'A third episode with an extremely long description to test multiple episode cards with problematic content. This episode continues the pattern of extensive text content that challenges the layout system.',
  ...
  episodes: [
    {
      ...
      podcastId: 'podcast-2',
      title:
        'Podcast 2 Episode 1: This Is Another Long Episode Title From The Second Podcast That Should Also Cause Layout Issues',
      description:
        'This episode from the second podcast also has a very long description to test the layout system with multiple podcasts and their episodes.',
...
test.describe('Library Page with Long Content', () => {
  ...
  test('should handle episode interactions with long titles', async ({ page }) => {
    ...
    const aiButton = page
      .locator('[data-testid="episode-card"]')
      .first()
      .locator('button[aria-label="Get AI explanation"]')
